...
| [HD-EPIC](https://arxiv.org/abs/2502.04144) | 2025-02 | arXiv | 41 hours, 9 kitchens, dense fine-grained labels, 3D fixture annotations, audio events, VQA | Detailed kitchen understanding, VQA, 3D-aware ego reasoning, audio-event recognition | open |
...
| [Ego-1K](https://huggingface.co/datasets/facebook/ego-1k) | 2026-03 | Hugging Face | Nearly 1,000 synchronized multiview egocentric videos from a custom 12-camera plus VR-headset rig | Dynamic 3D/4D scene understanding and novel view synthesis from ego rigs | open |
...
| [EgoBlind](https://arxiv.org/abs/2503.08221) | 2025-03 | arXiv | 1,392 first-person videos from blind and visually impaired users, 5,311 questions posed or verified by blind users | Assistive egocentric VideoQA for blind users | watch |
| [Look and Tell](https://arxiv.org/abs/2510.22672) | 2025-10 | arXiv | 25 participants, Project Aria plus stationary cameras, gaze/speech/video, 3D reconstructions | Referential communication across ego and exo viewpoints | watch |
...
| Resource | Released | Venue | Scale / signal | Best for | Status |
|---|---|---|---|---|---|
| [EgoDex](https://arxiv.org/abs/2505.11709) | 2025-05 | arXiv | 829 hours of Apple Vision Pro egocentric video, 194 tabletop tasks, 3D hand/finger tracking | Dexterous manipulation, imitation learning, human-to-robot hand trajectory prediction | watch |
...
| [EgoPAT3D / EgoPAT3Dv2](https://arxiv.org/abs/2403.05046) | 2024-03 | arXiv | 1M+ RGB-D/IMU frames in the original task; v2 expands egocentric 3D action-target prediction | Human-robot interaction, 3D target anticipation, manipulation safety | open |
...
| [EgoEngine](https://egoengine.github.io/) | 2025 | project page | Framework converting egocentric human manipulation video into robot observation/action data | Human-to-robot data generation, dexterous imitation | watch |
...
| [InterVLA](https://arxiv.org/abs/2508.04681) | 2025-08 | arXiv | 11.4 hours and 1.2M frames with 2 ego and 5 exo views, human/object motions, and verbal commands | Vision-language-action and motion estimation | watch |
...
| Resource | Released | Venue | Scale / signal | Best for | Status |
|---|---|---|---|---|---|
| [HOT3D](https://facebookresearch.github.io/hot3d/) | 2024-06 | arXiv | 833+ minutes, 3.7M+ images, Aria and Quest 3, gaze, point clouds, 3D hand/object/camera poses | 3D hand-object tracking for AR/VR manipulation | open |
...
| [UnrealEgo](https://4dqv.mpi-inf.mpg.de/UnrealEgo/) | 2022-08 | arXiv | Synthetic stereo eyeglass egocentric dataset with 3D human pose | Robust egocentric 3D human motion capture | open |
...
| [TouchMoment](https://arxiv.org/abs/2604.12343) | 2026-04 | arXiv | 4,021 egocentric videos, 8,456 annotated hand-object contact moments | Precise contact moment detection | watch |
...
| [SHOW3D](https://arxiv.org/abs/2603.28760) | 2026-03 | arXiv | In-the-wild 3D hand-object interactions from a back-mounted multi-camera rig synced to a worn VR headset, with multi-view 3D shape/pose and text | In-the-wild 3D hand-object reconstruction | watch |
...
| Resource | Released | Venue | Scale / signal | Best for | Status |
|---|---|---|---|---|---|
| [EgoLife](https://arxiv.org/abs/2503.03803) | 2025-03 | arXiv | 300 hours from six participants over one week with Meta Aria, third-person references, and EgoLifeQA | Long-term daily-life memory, personalized assistants, ultra-long QA | partial |
...
| [MyEgo](https://github.com/Ryougetsu3606/MyEgo) | 2026-04 | arXiv | 541 long videos and 5K personalized questions about the camera wearer, belongings, activities, and past | Personalized ego-grounding and long-range memory QA | open |
...
| [EgoSound](https://arxiv.org/abs/2602.14122) | 2026-02 | arXiv | 7,315 validated QA pairs across 900 Ego4D/EgoBlind videos | Sound perception, spatial localization, causal audio-visual reasoning | watch |
...
| [EASG-Bench](https://github.com/fpv-iplab/EASG-bench) | 2025-06 | arXiv | Egocentric action-scene-graph-based video QA benchmark | Scene graph, temporal order, and relation-aware QA | open |
...
| [Ego2Web](https://arxiv.org/abs/2603.22529) | 2026-03 | arXiv | Egocentric videos paired with web tasks requiring physical-scene understanding and online execution | Web agents grounded in first-person physical context | watch |
...
| [EgoTrigger / HME-QA](https://arxiv.org/abs/2508.01915) | 2025-08 | arXiv | Audio-driven smart-glasses capture strategy plus 340 first-person HME-QA pairs from full-length Ego4D videos | Energy-efficient memory assistance and audio-triggered capture | watch |
...
| [Gesture-Based Egocentric Video QA](https://arxiv.org/abs/2603.12533) | 2026-03 | arXiv | Egocentric video QA grounded in the camera wearer's pointing and deictic gestures | Gesture-grounded referential QA | watch |
...
| [EgoNight](https://insait-institute.github.io/EgoNight/) | 2025-10 | arXiv | EgoNight-VQA (3,658 QA / 90 videos / 12 types) plus day-night retrieval and depth, with day-night aligned video | Nighttime / low-light egocentric robustness | open |
...
| [SuperGlasses](https://arxiv.org/abs/2602.22683) | 2026-02 | arXiv | Evaluates VLMs as intelligent agents for AI smart glasses across realistic wearable assistant tasks | Smart-glasses agent evaluation | watch |
...
| [Wrist-mounted ADL](https://arxiv.org/abs/1511.06783) | 2015-11 | arXiv | Synchronized head and wrist wearable-camera daily activities | Comparing head- versus wrist-mounted first-person views | open |
...
| [Home Action Genome / HOMAGE](https://homeactiongenome.org/) | 2021-05 | arXiv | 27 participants, synchronized ego and third-person views, 12 sensor types, hierarchical activity/action labels | Compositional multi-view home activity understanding | open |
...
| [EgoEMS](https://arxiv.org/abs/2511.09894) | 2025-11 | arXiv | High-fidelity multimodal egocentric data for cognitive assistance in emergency medical services, capturing time-critical team actions | Real-time medical procedural assistance | watch |
...
| [Digital Twin Catalog / DTC](https://www.projectaria.com/datasets/dtc/) | 2025-04 | arXiv | 2,000 scanned objects with DSLR and egocentric AR-glasses image sequences | Digital-twin object reconstruction and evaluation | open |
...
| [EgoClip / EgoMCQ](https://github.com/showlab/EgoVLP) | 2022-06 | arXiv | Ego4D | 3.8M clip-text pairs and MCQ development benchmark for egocentric VLP | open |
...
| [EgoHOIBench / EgoNCE++](https://github.com/xuboshen/EgoNCEpp) | 2024-05 | arXiv | Multiple egocentric HOI sources | Open-vocabulary hand-object interaction understanding | open |
| [EASG-Bench](https://github.com/fpv-iplab/EASG-bench) | 2025-06 | arXiv | Egocentric action scene graphs | Relation and temporal QA | open |
...
| [Audio Hallucination in Egocentric Video](https://arxiv.org/abs/2604.23860) | 2026-04 | arXiv | Egocentric audio-visual video | 300 videos / 1,000 sound-focused questions probing audio hallucination in AV-LLMs | watch |
...
| EgoM2P | 2025-06 | arXiv | Egocentric multimodal multitask pretraining over RGB, depth, gaze, and camera pose | [Paper](https://arxiv.org/abs/2506.07886) |
...
| Vinci | 2024-12 | arXiv | Real-time, always-on egocentric assistant with historical-context QA, planning, and visual demos | [GitHub](https://github.com/OpenGVLab/vinci) |
...
| EgoNCE++ | 2024-05 | arXiv | Open-vocabulary HOI benchmark and asymmetric contrastive objective | [GitHub](https://github.com/xuboshen/EgoNCEpp) |
...
| MM-Ego | 2024-10 | arXiv | Egocentric multimodal LLM with Memory Pointer Prompting and a 7M-sample egocentric QA data engine (EgoMemoria benchmark) | [Paper](https://arxiv.org/abs/2410.07177) |
...
| EgoThinker | 2025-10 | arXiv | Egocentric reasoning model with spatio-temporal chain-of-thought and RL fine-tuning | [Paper](https://arxiv.org/abs/2510.23569) |
...
| Ego-Exo representation transfer | 2021-04 | arXiv | Distillation from third-person video using ego-specific latent signals | [Paper](https://arxiv.org/abs/2104.07905) |
...
| CONE | 2022-11 | arXiv | Coarse-to-fine alignment framework for Ego4D Natural Language Queries | [Paper](https://arxiv.org/abs/2211.08776) |
| EgoHandTrajPred / USST | 2023-07 | arXiv | Egocentric 3D hand trajectory forecasting over H2O and EgoPAT3D-style settings | [Project](https://actionlab-cv.github.io/EgoHandTrajPred) |
