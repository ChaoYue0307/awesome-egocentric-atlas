...
const I18N = {
  en: {
    ...
    "proof.1": "Datasets, benchmarks, models & tools", "proof.2": "Filter by task, status, and date", "proof.3": "Access and license notes included",
  ...
  zh: {
    ...
    "proof.1": "数据集、基准、模型与工具", "proof.2": "按任务、状态与日期筛选", "proof.3": "包含访问状态与许可说明",
  ...
  es: {
    ...
    "proof.1": "Datos, benchmarks, modelos y herramientas", "proof.2": "Filtra por tarea, estado y fecha", "proof.3": "Incluye notas de acceso y licencia",
  ...
  fr: {
    ...
    "proof.1": "Données, benchmarks, modèles et outils", "proof.2": "Filtrer par tâche, statut et date", "proof.3": "Accès et licences documentés",
  ...
  de: {
    ...
    "proof.1": "Datensätze, Benchmarks, Modelle & Werkzeuge", "proof.2": "Nach Aufgabe, Status und Datum filtern", "proof.3": "Zugang und Lizenzen dokumentiert",
  ...
  ja: {
    ...
    "proof.1": "データセット・ベンチマーク・モデル・ツール", "proof.2": "タスク・状態・日付で絞り込み", "proof.3": "アクセス状況とライセンス情報を掲載",
  ...
  ko: {
    ...
    "proof.1": "데이터셋·벤치마크·모델·도구", "proof.2": "작업·상태·날짜로 필터링", "proof.3": "접근 상태와 라이선스 정보 제공",
  ...
  pt: {
    ...
    "proof.1": "Dados, benchmarks, modelos e ferramentas", "proof.2": "Filtre por tarefa, estado e data", "proof.3": "Inclui notas de acesso e licença",
