...
T = {
  "en" => { tagline: "Datasets, benchmarks, models, and tools for egocentric vision, embodied AI and robotics, video-language, long-context memory, AR/VR, and hand-object interaction.",
  ...
  "zh" => { tagline: "用于自我中心视觉、具身智能与机器人、视频语言、长上下文记忆、AR/VR 和手物交互的数据集、基准、模型与工具。",
  ...
  "es" => { tagline: "Conjuntos de datos, benchmarks, modelos y herramientas para visión egocéntrica, IA encarnada y robótica, video-lenguaje, memoria de largo contexto, RA/RV e interacción mano-objeto.",
  ...
  "fr" => { tagline: "Jeux de données, benchmarks, modèles et outils pour la vision égocentrique, l'IA incarnée et la robotique, le vidéo-langage, la mémoire à long contexte, la RA/RV et l'interaction main-objet.",
  ...
  "de" => { tagline: "Datensätze, Benchmarks, Modelle und Werkzeuge für egozentrisches Sehen, verkörperte KI und Robotik, Video-Sprache, Langzeitgedächtnis, AR/VR und Hand-Objekt-Interaktion.",
  ...
  "ja" => { tagline: "エゴセントリック視覚、身体性 AI とロボティクス、ビデオ言語、長文脈記憶、AR/VR、手と物体の相互作用に使うデータセット・ベンチマーク・モデル・ツール。",
  ...
  "ko" => { tagline: "자기중심 비전, 체화 AI와 로보틱스, 비디오-언어, 장문맥 기억, AR/VR, 손-물체 상호작용을 위한 데이터셋·벤치마크·모델·도구.",
  ...
  "pt" => { tagline: "Conjuntos de dados, benchmarks, modelos e ferramentas para visão egocêntrica, IA incorporada e robótica, vídeo-linguagem, memória de longo contexto, RA/RV e interação mão-objeto.",
